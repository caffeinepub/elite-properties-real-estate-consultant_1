...
export default function Contact() {
  return (
    <section id="contact" className="section-padding bg-charcoal-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <p className="font-body text-charcoal-300 text-base sm:text-lg max-w-xl mx-auto">
            Ready to find your dream property? Reach out to us today and let our experts assist you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-4 p-6 bg-charcoal-800/60 border border-charcoal-700 rounded-sm hover:border-gold-600/40 transition-colors group">
              ...
              <div>
                <h3 className="font-display font-semibold text-white text-base mb-1">Our Office</h3>
                <p className="font-body text-charcoal-300 text-sm leading-relaxed">
                  Zala Society Building No 1, Office No 6,<br />
                  First Floor, Karve Rd,<br />
                  Near Karishma Chowk, Kothrud,<br />
            ...
            <div className="flex gap-4 p-6 bg-charcoal-800/60 border border-charcoal-700 rounded-sm hover:border-gold-600/40 transition-colors group">
              ...
              <div>
                <h3 className="font-display font-semibold text-white text-base mb-1">Business Hours</h3>
                ...
                <p className="font-body text-charcoal-400 text-xs mt-1">Open all days including holidays</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-charcoal-800/60 border border-charcoal-700 rounded-sm hover:border-gold-600/40 transition-colors group">
              ...
              <div>
                <h3 className="font-display font-semibold text-white text-base mb-1">Phone</h3>
                <a
                ...
                <p className="font-body text-charcoal-400 text-xs mt-0.5">Tap to call directly</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="font-body text-charcoal-300 text-sm mb-6 leading-relaxed max-w-xs mx-auto">
                  Chat with us instantly on WhatsApp for quick responses, property details, and personalized assistance.
                </p>
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-3 gold-gradient text-charcoal-900 font-body font-bold text-base px-8 py-4 rounded-sm shadow-gold-lg hover:opacity-90 transition-all duration-200 hover:scale-105 w-full"
                >
                ...
                <div className="mt-6 pt-6 border-t border-charcoal-700">
                  <p className="font-body text-charcoal-400 text-xs mb-3">Or reach us via</p>
                  <div className="flex justify-center gap-4">
                    <a
                      href="tel:+919527942323"
                      className="flex items-center gap-2 text-gold-400 hover:text-gold-300 font-body text-sm font-medium transition-colors"
                    >
                      <Phone size={15} />
                      Call Now
                    </a>
            ...
            <div className="mt-5 grid grid-cols-2 gap-4">
              <div className="p-4 bg-charcoal-800/60 border border-charcoal-700 rounded-sm text-center">
                <div className="font-display font-bold text-gold-400 text-xl">24/7</div>
                <div className="font-body text-charcoal-400 text-xs mt-0.5">WhatsApp Support</div>
              </div>
              <div className="p-4 bg-charcoal-800/60 border border-charcoal-700 rounded-sm text-center">
                <div className="font-display font-bold text-gold-400 text-xl">Free</div>
                <div className="font-body text-charcoal-400 text-xs mt-0.5">Consultation</div>
              </div>
            </div>
          </div>
        </div>
