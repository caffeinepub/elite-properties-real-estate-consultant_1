      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-body text-charcoal-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            With over a decade of excellence in Pune's real estate market, we bring unmatched expertise,
            integrity, and dedication to every client relationship.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {stats.map((stat) => (
            ...
            >
              ...
              <div className="font-body text-charcoal-300 text-sm">{stat.label}</div>
            </div>
          ))}
        </div>
          ...
          {highlights.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className="font-body text-charcoal-300 text-sm leading-relaxed">{item.description}</p>
              </div>
            );
          })}
        </div>
