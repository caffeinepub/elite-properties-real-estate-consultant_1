...
const Building = createLucideIcon("building", __iconNode$A);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Car = createLucideIcon("car", __iconNode$z);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Hammer = createLucideIcon("hammer", __iconNode$q);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const HardHat = createLucideIcon("hard-hat", __iconNode$p);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const LandPlot = createLucideIcon("land-plot", __iconNode$l);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Sofa = createLucideIcon("sofa", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Tractor = createLucideIcon("tractor", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const highlights = [
  {
    ...
    description: "Recognized as Pune's most reliable real estate consultancy with a proven track record of transparent dealings and client satisfaction."
  },
  {
    icon: Award,
    title: "Expert Consultants",
    description: "Our team of seasoned professionals brings deep market knowledge and expertise to guide you through every step of your property journey."
  },
  {
    icon: Users,
    title: "Client-First Approach",
    description: "We prioritize your needs above all else, offering personalized consultations and tailored solutions for every unique requirement."
  },
  {
    icon: TrendingUp,
    title: "Smart Investments",
    description: "Leverage our market insights to make informed investment decisions that maximize returns and secure your financial future."
  },
  {
    icon: Building2,
    title: "End-to-End Services",
    description: "From property search to documentation, loans to registration — we handle everything so you can focus on what matters most."
  },
  {
    icon: CircleCheckBig,
    title: "Verified Properties",
    description: "Every property we list is thoroughly verified for legal compliance, ensuring a safe and hassle-free transaction for our clients."
  }
];
const stats = [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gold-400 text-sm font-semibold tracking-widest uppercase", children: "About Us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold-500" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-white text-3xl sm:text-4xl md:text-5xl mb-4", children: [
              "Why Choose",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "Elite Properties"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed", children: "With over a decade of excellence in Pune's real estate market, we bring unmatched expertise, integrity, and dedication to every client relationship." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-16", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-charcoal-300 text-sm", children: stat.label })
              ]
            },
            stat.label
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: highlights.map((item) => {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, oklch(0.68 0.14 72), oklch(0.80 0.13 78), oklch(0.54 0.13 65))"
                      },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, className: "text-charcoal-900" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-white text-lg mb-2", children: item.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-sm leading-relaxed", children: item.description })
                ]
              },
              item.title
            );
          }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 rounded-sm overflow-hidden relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-charcoal-900/60 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-white text-2xl sm:text-3xl md:text-4xl mb-2", children: "Kothrud, Pune's Premier" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(90deg, oklch(0.68 0.14 72), oklch(0.80 0.13 78), oklch(0.54 0.13 65))"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gold-400 text-sm font-semibold tracking-widest uppercase", children: "Get In Touch" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold-500" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-white text-3xl sm:text-4xl md:text-5xl mb-4", children: [
              "Contact",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-base sm:text-lg max-w-xl mx-auto", children: "Ready to find your dream property? Reach out to us today and let our experts assist you." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 p-6 bg-charcoal-800/60 border border-charcoal-700 rounded-sm hover:border-gold-600/40 transition-colors group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 20, className: "text-charcoal-900" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-white text-base mb-1", children: "Our Office" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-charcoal-300 text-sm leading-relaxed", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 p-6 bg-charcoal-800/60 border border-charcoal-700 rounded-sm hover:border-gold-600/40 transition-colors group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 20, className: "text-charcoal-900" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-white text-base mb-1", children: "Business Hours" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-sm", children: "Monday – Sunday" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold-400 font-semibold text-base mt-0.5", children: "9:30 AM – 8:30 PM" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-400 text-xs mt-1", children: "Open all days including holidays" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 p-6 bg-charcoal-800/60 border border-charcoal-700 rounded-sm hover:border-gold-600/40 transition-colors group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 20, className: "text-charcoal-900" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-white text-base mb-1", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: "tel:+919527942323",
                      className: "font-body text-gold-400 hover:text-gold-300 font-semibold text-lg transition-colors",
                      children: "095279 42323"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-400 text-xs mt-0.5", children: "Tap to call directly" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(0.16 0.01 260), oklch(0.20 0.01 260))"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { size: 36, className: "text-charcoal-900" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-2xl sm:text-3xl mb-3", children: "WhatsApp Enquiry" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-sm mb-6 leading-relaxed max-w-xs mx-auto", children: "Chat with us instantly on WhatsApp for quick responses, property details, and personalized assistance." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "a",
                        {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-charcoal-800/60 border border-charcoal-700 rounded-sm text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-gold-400 text-xl", children: "24/7" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-charcoal-400 text-xs mt-0.5", children: "WhatsApp Support" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-charcoal-800/60 border border-charcoal-700 rounded-sm text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-gold-400 text-xl", children: "Free" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-charcoal-400 text-xs mt-0.5", children: "Consultation" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold-500/60" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gold-400 text-xs font-semibold tracking-widest uppercase", children: "Property Enquiry" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold-500/60" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-2xl sm:text-3xl", children: "Send Us Your Requirement" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-400 text-sm mt-2", children: "Fill in your details and we'll get back to you promptly." })
                ] }),
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 32, className: "text-charcoal-900" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-white text-xl", children: "Thank you!" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-base", children: "We'll contact you shortly." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "label",
                          {
                            ...
                            children: [
                              "Full Name ",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold-400", children: "*" })
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "select",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, children: "Select property type" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "commercial-rent", children: "Commercial Rent" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "commercial-sale", children: "Commercial Sale" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "residential-property", children: "Residential Property" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "plot-selling", children: "Plot Selling" })
                            ]
                          }
                        )
                      ] }),
...
function Footer() {
  ...
  const appId = encodeURIComponent(
    typeof window !== "undefined" ? window.location.hostname : "elite-properties-pune"
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-charcoal-900 border-t border-charcoal-700 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute top-0 left-0 right-0 h-1",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-charcoal-800 rounded-xl overflow-hidden w-12 h-12 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-gold-400 text-lg leading-tight", children: "Elite Properties" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-charcoal-400 text-xs tracking-wider uppercase", children: "Real Estate Consultant" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-sm leading-relaxed mb-3", children: "Elite Properties Real Estate Consultant" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold-500/80 text-sm leading-relaxed mb-5", children: "एलिट प्रोपर्टीज रियल एस्टेट कंसलटेंट" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-400 text-xs leading-relaxed", children: "Pune's most trusted real estate consultancy, delivering excellence in property services since our founding." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-white text-base mb-5 pb-2 border-b border-charcoal-700", children: "Contact Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-charcoal-300 text-sm leading-relaxed", children: [
                "Zala Society Building No 1, Office No 6, First Floor,",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Karve Rd, Near Karishma Chowk,",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-charcoal-300 text-sm", children: [
                  "Mon – Sun:",
                  " "
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gold-400 text-sm font-semibold", children: "9:30 AM – 8:30 PM" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-white text-base mb-5 pb-2 border-b border-charcoal-700", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mb-6", children: ["Home", "About", "Services", "Contact"].map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { size: 16 }),
                "WhatsApp Enquiry"
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "h-px mb-6",
          style: {
            background: "linear-gradient(90deg, transparent, oklch(0.68 0.14 72 / 0.4), transparent)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-charcoal-500 text-xs", children: [
          "© ",
          year,
          " Elite Properties Real Estate Consultant. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-charcoal-500 text-xs flex items-center gap-1", children: [
          "Built with",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 12, className: "text-gold-500 fill-gold-500" }),
          " using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-charcoal-900/75" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 opacity-25",
            style: {
              background: "linear-gradient(135deg, oklch(0.68 0.14 72 / 0.5) 0%, transparent 55%, oklch(0.44 0.11 62 / 0.35) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-gold-500/15 border border-gold-500/35 rounded-full px-5 py-2 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 13, className: "text-gold-400 fill-gold-400" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "font-body text-xs font-bold tracking-widest uppercase",
                style: { color: "#f5e6c0" },
                children: "Pune's Most Trusted Real Estate Business"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 13, className: "text-gold-400 fill-gold-400" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-white leading-tight mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight drop-shadow-lg", children: "Elite Properties" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: "Real Estate Consultant"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold-300/80 text-lg sm:text-xl md:text-2xl mb-4 tracking-wide", children: "एलिट प्रोपर्टीज रियल एस्टेट कंसलटेंट" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Your Trusted Partner for Commercial and Residential Purchase or Leasing"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: "https://wa.me/919527942323",
                ...
                style: {
                  background: "linear-gradient(135deg, #f5c842, #d4a017, #f5c842)",
                  color: "#1a1a1a",
                  boxShadow: "0 0 18px rgba(212,160,23,0.7), 0 4px 14px rgba(0,0,0,0.3)",
                  border: "1.5px solid #f5c842"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 20 }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 max-w-lg mx-auto", children: [
            { value: "500+", label: "Properties Sold" },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-charcoal-300 text-xs sm:text-sm mt-0.5", children: stat.label })
          ] }, stat.label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-white/95 backdrop-blur-md shadow-xl shadow-black/10 border-b border-gold-200" : "bg-white/90 backdrop-blur-sm border-b border-gold-100"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-20 md:h-24 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 group-hover:scale-105 transition-transform duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-[#0a0a0a] text-2xl md:text-3xl lg:text-4xl leading-tight tracking-tight", children: "Elite Properties" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body font-semibold text-gold-600 text-xs md:text-sm leading-tight tracking-widest uppercase mt-0.5", children: "Real Estate Consultant" })
                ] })
              ]
            }
          ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "095279 42323" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: mobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 26 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 26 })
            }
          )
        ] }) }),
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-t border-gold-100 px-4 pb-4 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col gap-1 pt-3", children: [
...
const residentialTypes = [
  ...
  { icon: Building, label: "Luxurious Flats" }
];
function FeaturedCommercialCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-background py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 sm:p-9 flex flex-col sm:flex-row gap-6 items-center sm:items-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-2xl sm:text-3xl mb-3 leading-snug", children: "Commercial Property Renting & Selling" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-sm sm:text-base leading-relaxed mb-5", children: "Specialized services for commercial real estate renting and selling across Pune. Our expert team ensures the best deals for all types of commercial spaces." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-5 justify-center sm:justify-start", children: commercialTypes.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, #f5c842, #d4a017, #f5c842)",
                        color: "#1a1a1a",
                        boxShadow: "0 0 16px rgba(212,160,23,0.65), 0 2px 10px rgba(0,0,0,0.25)",
                        border: "1.5px solid #f5c842"
                      },
                      children: "Enquire Now"
                    }
...
function FeaturedResidentialCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-background py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7 sm:p-9 flex flex-col sm:flex-row gap-6 items-center sm:items-start", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-white text-2xl sm:text-3xl mb-3 leading-snug", children: "Residential Property Renting & Selling" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-charcoal-300 text-sm sm:text-base leading-relaxed mb-5", children: "Discover your perfect home with our residential renting and selling services across Pune. From cozy flats to grand bungalows — we find the right match for every family." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-5 justify-center sm:justify-start", children: residentialTypes.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold",
                      style: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gold-600 text-sm font-semibold tracking-widest uppercase", children: "What We Offer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold-500" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-foreground text-3xl sm:text-4xl md:text-5xl mb-4", children: [
              "Our",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto leading-relaxed", children: "Comprehensive real estate solutions tailored to meet every property need — from residential to commercial, buying to investing." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: services.map((service) => {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(90deg, oklch(0.68 0.14 72), oklch(0.80 0.13 78))"
                      }
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-sm gold-gradient flex items-center justify-center mb-4 shadow-gold group-hover:scale-110 transition-transform duration-300 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, className: "text-charcoal-900" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-base mb-2 leading-snug", children: service.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-xs leading-relaxed", children: service.desc })
                ]
              },
              service.title
            );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mt-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-sm mb-4", children: "Not sure which service you need? Let our experts guide you." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://wa.me/919527942323",
                ...
                style: {
                  background: "linear-gradient(135deg, #f5c842, #d4a017, #f5c842)",
                  color: "#1a1a1a",
                  boxShadow: "0 0 16px rgba(212,160,23,0.6), 0 2px 10px rgba(0,0,0,0.25)",
                  border: "1.5px solid #f5c842"
                },
                children: "Get Free Consultation on WhatsApp"
              }
            )
          ] })
        ] })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedCommercialCard, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedResidentialCard, {}),
