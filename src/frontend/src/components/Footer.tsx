    ...
    <footer className="bg-charcoal-900 border-t border-charcoal-700 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="font-body text-charcoal-400 text-xs leading-relaxed">
              Pune's most trusted real estate consultancy, delivering excellence
              in property services since our founding.
            </p>
          </div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <span className="font-body text-gold-400 text-sm font-semibold">
                    9:30 AM – 8:30 PM
                  </span>
                </div>
              </li>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, oklch(0.68 0.14 72 / 0.4), transparent)",
          }}
        />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-center">
          <p className="font-body text-charcoal-500 text-xs">
            © {year} Elite Properties Real Estate Consultant. All rights
            reserved.
          </p>
